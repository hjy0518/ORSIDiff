...
from model.simple_diffusion import *
...
class CondGaussianDiffusion(GaussianDiffusion):
    ...
    def p_losses(self, x_start, times, cond_img, seg=None, extra_cond=None, noise=None, *args, **kwargs):
        ...
        if self.loss_type == 'l2':
            ...
            # loss1 = self.loss_type(model_out, target)
            # loss2 = self.loss_type(p2, target)
            # loss3 = self.loss_type(p3, target)
            # loss4 = self.loss_type(p4, target)
